...
router.put("/solicitudes-prestador/:id/rechazar", authMiddleware.verifyToken, controller.rejectSolicitud);
router.get("/", controller.getAllPrestadores);
router.get("/:id", authMiddleware.verifyToken, controller.getPrestadorById);
router.put(
  "/update/:id",
  authMiddleware.verifyToken,
  controller.updatePrestador
);
router.put(
  "/:id/categorias",
  authMiddleware.verifyToken,
...
router.get(
  "/:id/solicitudes",
  authMiddleware.verifyToken,
  controller.getSolicitudesByPrestadorId
);
router.get(
  "/:id/promedio-calificaciones",
  authMiddleware.verifyToken,
...
router.post(
  ...
  authMiddleware.verifyToken,
  controller.getPresupuestosEnviados
);
router.post(
  "/solicitudes/rechazar",
  authMiddleware.verifyToken,
  controller.rejectSolicitud
);
