...
module.exports = {
    ...
    async createUser(userData) {
        const { correo, contrasena, nombre_completo, id_ubicacion, id_rol, rol, telefono, descripcion, experiencia, categorias } = userData;
    ...
    async updateUserProfile(id_usuario, updateData) {
        const { nombre_completo, telefono, id_ubicacion, descripcion, experiencia, categorias } = updateData;
            ...
            if (usuario.rol.nombre === 'Cliente') {
                ...
                if (prestador) {
                    await prestador.update({
                        ...
                        descripcion: descripcion !== undefined ? descripcion : prestador.descripcion,
                        experiencia: experiencia !== undefined ? experiencia.toString() : prestador.experiencia
                    });

                    // Actualizar categorías si se proporcionaron
                    if (categorias && Array.isArray(categorias)) {
                        // Eliminar categorías existentes
                        await PrestadorCategoria.destroy({ where: { id_prestador: prestador.id_prestador } });
